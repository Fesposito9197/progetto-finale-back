...
<div class="container">
    ...
    <form action="{{route('admin.companies.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input class="form-control @error('minimum_order') is-invalid @enderror" type="number" placeholder="minimum_order" id="minimum_order" name="minimum_order" value="{{old('minimum_order')}}" required step="0.01">
            @error('minimum_order')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
